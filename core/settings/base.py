...
# Static assets stay on the local filesystem in dev and are switched to
# ``core.storage.StaticS3Storage`` in production.py.
AWS_ACCESS_KEY_ID = env("AWS_ACCESS_KEY_ID", default="")
AWS_SECRET_ACCESS_KEY = env("AWS_SECRET_ACCESS_KEY", default="")
AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="")
AWS_S3_ENDPOINT_URL = env("AWS_S3_ENDPOINT_URL", default="")
AWS_S3_PUBLIC_URL = env("AWS_S3_PUBLIC_URL", default=AWS_S3_ENDPOINT_URL)
...
TEMPLATE_WIDGETS = {
    ...
    "selectmultiple": "widgets/selectinput.html",
...
TEMPLATE_WIDGETS_DETAIL = {
    ...
    "FileField": "detail_widgets/image.html",
